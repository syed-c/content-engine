      ...
      <div className="lg:hidden flex-grow flex flex-col px-6 pb-24">
        ...
        <section className="mt-8 mb-12 max-w-sm">
          ...
          <h1 className="text-5xl font-black font-headline tracking-tighter leading-[0.9] text-primary mb-4">
            Access the <br/>Engine
          </h1>
          <p className="text-on-surface-variant text-sm leading-relaxed max-w-[80%]">
            Authentication required for programmatic SEO sequence initiation.
          </p>
        </section>
            ...
            <form onSubmit={handleLogin} className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="relative group">
                  <label className="block text-[10px] font-bold uppercase tracking-widest text-on-surface-variant mb-2 ml-1">Identity</label>
                  <input 
                ...
                <div className="relative group">
                  <label className="block text-[10px] font-bold uppercase tracking-widest text-on-surface-variant mb-2 ml-1">Access Key</label>
                  <input 
                    className="w-full bg-surface-container-high border-none rounded-lg py-4 px-4 text-on-surface placeholder:text-on-surface/30 focus:ring-1 focus:ring-on-surface/10 transition-all outline-none" 
                    placeholder="••••••••" 
                    type="password"
              ...
              <div className="pt-4">
                ...
                >
                  <span className="tracking-tight uppercase">{loading ? 'Initializing...' : 'Initialize Session'}</span>
                  <span className="material-symbols-outlined group-hover:translate-x-1 transition-transform">arrow_forward</span>
                </button>
              </div>
            </form>
            <div className="mt-8 flex justify-between items-center">
              <Link href="/contact" className="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant hover:text-primary transition-colors">
                Forgot Key?
              </Link>
              <Link href="/register" className="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant hover:text-primary transition-colors">
                Register Node
              </Link>
            </div>
          </div>
          ...
          <div className="relative z-10 flex flex-col justify-between h-full p-12">
            ...
            <div className="space-y-6">
              <h2 className="text-5xl font-headline font-extrabold text-white leading-tight">
                Brief-to-Published<br/>at Scale
              </h2>
              <p className="text-white/70 font-body text-lg max-w-md">
                The AI-native programmatic SEO platform that takes a keyword — and returns a fully published, schema-marked article.
              </p>
            </div>
        ...
        <div className="w-1/2 flex items-center justify-center p-12">
          <div className="w-full max-w-md space-y-8">
            <div className="text-center lg:text-left">
              <h3 className="text-3xl font-headline font-extrabold text-primary">Welcome back</h3>
              <p className="text-on-primary-container font-body mt-2">Sign in to continue to your workspace</p>
            </div>
